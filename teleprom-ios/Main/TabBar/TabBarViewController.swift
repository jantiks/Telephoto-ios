...
class TabBarViewController: BaseTabBarViewController {
    ...
    override func viewDidLoad() {
        ...
        setupVCs([
            TabBarViewControllerConfig(controller: BaseNavigationController(rootViewController: RecordsViewController()), tabBarItemTitle: "main.tab.records", tabBarItemImage: UIImage(named: "notes")!),
